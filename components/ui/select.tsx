...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(
      'native:pb-2 native:pl-10 native:text-base py-1.5 pl-8 pr-2 font-qs-bold text-sm font-semibold text-popover-foreground',
      className
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    <SelectPrimitive.ItemText className="native:text-base font-qs-medium text-sm text-popover-foreground web:group-focus:text-accent-foreground" />
  </SelectPrimitive.Item>
));
